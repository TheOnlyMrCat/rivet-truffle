...
class rivet(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","rivet")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for rivet start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            simcmd = self.dut_exe + ' --signature-out {1} {2}'.format(self.isa, sig_file, os.path.abspath(os.path.join(test_dir, elf)))
          else:
            simcmd = 'echo "NO RUN"'
