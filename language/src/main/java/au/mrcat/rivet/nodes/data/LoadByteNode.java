...
public class LoadByteNode extends RivetOpNode {
    ...
    public LoadByteNode(RivetOpNode address, int offset, long pcOffset, short instret) {
    ...
    public long executeLong(VirtualFrame frame, long basePc, PrivilegedContext priv) {
        ...
        try {
            return ctx.physicalMemory.readByte(priv.translateReadAddress(virtualAddress, ctx));
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("LoadByteNode{");
