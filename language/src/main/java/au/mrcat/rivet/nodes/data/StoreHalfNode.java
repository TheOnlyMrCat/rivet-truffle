...
public class StoreHalfNode extends RivetNode {
    ...
    public StoreHalfNode(RivetOpNode address, long offset, RivetOpNode value, long pc, short instret) {
    ...
    public void executeVoid(VirtualFrame frame) {
        ...
        try {
            ctx.writeShort(virtualAddress, (short) value.executeLong(frame));
